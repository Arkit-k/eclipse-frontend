                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4><a href="tel:670-413-90-762">+9322359274</a></h4>
                    </div>
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:shofy@support.com">ahiretanmay2005@gmail.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="https://maps.app.goo.gl/yq9F1gVGsSQCNTi3A" target="_blank">ulhasnagar <br /> Mumbai</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="tp-footer-copyright">
                    <p>© {new Date().getFullYear()} All Rights Reserved  |  tanmay & Eclipse
                      <Link href="/">{" "}❤</Link>.
                    </p>
                  </div>
                </div>
